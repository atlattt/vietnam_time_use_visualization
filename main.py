...
data = data.iloc[:int(len(data)/4)]#lấy 1/4 dữ liệu để trực quan hóa dễ hơn
d3 = D3Blocks()
d3.movingbubbles(data, sample_id="sample_id", datetime="datatime", state="state", filepath="./moving_point.html",
